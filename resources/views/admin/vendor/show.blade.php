...
<div class="row">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
            @if($vendor->show_verified_badge ==0)
	...
	<div class="panel panel-danger">
		...
		<div class="panel-body">
			<button id="delete-vendor" data-record-id="{{$vendor->id}}" class="btn btn-danger">Delete Profile</button>
...
<script>
	...
	var vendorBaseUrl = "{{ route('admin::all-vendors') }}";
