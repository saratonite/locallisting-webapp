		...
		<div class="panel-body">
			<div class="col-md-12" style="padding:0px">
			    ...
			    <a  class="thumbnail" style="padding:0px">
			    	<!-- Dummy -->
			    	<img ng-hide="vendor.logo || file"  ng-src="{{url('/')}}/images/placeholder.png">
			    	<!-- The Current -->
			    	<img ng-hide="file || !vendor.logo " ng-src="{{url('/').'/'.config('settings.uploads.images')}}@{{vendor.logo.base_dir}}/@{{vendor.logo.file_name}}">
			    	<!-- New -->
