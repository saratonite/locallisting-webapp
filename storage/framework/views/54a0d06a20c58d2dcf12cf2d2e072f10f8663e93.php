	...
	<div class="col-md-5">
		...
		<!-- End Vendor Profile Status -->
			...
			<div class="panel panel-danger">
				...
				<div class="panel-body">
					<button id="delete-user" data-record-id="<?php echo e($user->id); ?>" class="btn btn-danger">Delete Profile</button>
...
<script>
	...
	var usersBaseUrl = "<?php echo e(route('admin::all-site-users')); ?>/";
